function jogo()
{
    ...
    var caixa = 
    [
        [document.getElementById("cx00").value, document.getElementById("cx10").value, document.getElementById("cx20").value],
        [document.getElementById("cx01").value, document.getElementById("cx11").value, document.getElementById("cx21").value],
        [document.getElementById("cx02").value, document.getElementById("cx12").value, document.getElementById("cx22").value]
    ]
    ...
    for(x = 0; x < 3; x++){
        for(y = 0; y < 3; y++){
            if(caixa[y][x] == "X" || caixa[y][x] == "O"){
                document.getElementById("cx"+x+y).disabled = true;
            }
        }   
    }
